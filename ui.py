...
def show_main_menu():
    ...
    print('[6] ' + 'Show specific packet information')
    print('[7] ' + 'Export specific packet to pdf')
    print('[8] ' + 'Get a network useage table')
    print('[9] ' + 'Get retransmissions (PER) and expert info')
    print('[10] ' + 'Get loading measurement Frames/Bytes per pcap interval')
    print('[11] ' + 'Get traffic from/to specific ip from specific time')
    print('[0] ' + 'exit')
    print()
...
def handle_user_selection(selected, reader):
    if 1 == selected: 
        ...
        time = input("Please enter time(for example like this 2017-01-01 12:30:05): ")
